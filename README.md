...
Clover P2P Reverse Shell is a Python script that allows you to establish a peer-to-peer (P2P) connection between two computers and execute shell commands on the remote computer.
